...
System.register(['../controllers/NegociacaoController', '../helpers/DateHelper', './View'], function (_export, _context) {
  "use strict";

  var currentInstance, DateHelper, View, _createClass, NegociacoesView;
      ...
      _export('NegociacoesView', NegociacoesView = function (_View) {
        ...
        function NegociacoesView(elemento) {
          ...
          elemento.addEventListener('click', function (event) {
            // testamos se quem disparou o evento foi um th
